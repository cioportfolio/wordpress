...
# From https://peteris.rocks/blog/unattended-installation-of-wordpress-on-ubuntu-server/

sudo apt-get update

echo "Set variables"
WP_DOMAIN="wordpress.test.site"
...
wget -q -o=wget.log https://wordpress.org/latest.tar.gz
...
curl "http://127.0.0.1:8080/wp-admin/install.php?step=2" \
